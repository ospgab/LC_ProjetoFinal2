...
import generator.AutoGenerated;

public abstract class BaseModel<ID> {
    public ID getId() {
        Field field = this.getAnnotatedField(PrimaryKey.class);
    ...
    public void autoGenerateId() {
        ...
        Field field = this.getAnnotatedField(AutoGenerated.class);
    ...
    private Field getAnnotatedField(Class<? extends Annotation> clazz) {
